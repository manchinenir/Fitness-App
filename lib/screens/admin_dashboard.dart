        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              runSpacing: 16,
              children: [
                _buildNavTile(context, Icons.calendar_today, 'Booked Sessions', const AdminCreateSlotsScreen()),
                ...
                _buildNavTile(context, FontAwesomeIcons.dumbbell, 'Workout Plans', null),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Icon(icon, size: 28, color: Color(0xFF1C2D5E)),
