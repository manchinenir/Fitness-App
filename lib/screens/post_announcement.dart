...
class _ReferralsTabState extends State<ReferralsTab> {
  ...
  // FIXED: Changed to App Store URL
  String _referralLink = 'https://apps.apple.com/us/app/flex-facility/id6755446262';
...
$_referralLink
''';
    await Share.share(message, sharePositionOrigin: _shareOrigin(ctx));
  }
